...
public class Lab4Controller
{
    ...
    @FXML
    private Button _l1n1BtnCalculate;
    //
    // Lab1.2
    //
    @FXML
    ...
    @FXML
    private Button _l1n2BtnCalculate;
    //
    // Lab2.1
    //
    @FXML
    ...
    @FXML
    private Button _l2BtnGenerateArrays;
    @FXML
     ...
     */
    @FXML
    private void L1n1BtnCalculate_Action(Event event)
    {
        _l1n1LblErrorMessage.setText("");
     ...
     */
    @FXML
    private void L1n2BtnCalculate_Action(Event event)
    {
        _l1n2LblErrorMessage.setText("");
     ...
     */
    @FXML
    private void L2BtnGenerateArrays_Action(Event e)
    {
        _l2LblGenerateArraysErrorMessage.setText(null);
     ...
     */
    @FXML
    private void L2BtnGo_Action(Event e)
    {
        _l2LblGoErrorMessage.setText(null);
        _l2LblArray1SearchResult.setText("...");
        _l2LblArray2SearchResult.setText("...");
        ...
        Lab2.SmallestItemSelectionSort(array1);
     ...
     */
    @FXML
    private void L3BtnGenerate_Action(Event e)
    {
        _l3LblGenerateErrorMessage.setText(null);
     ...
     */
    @FXML
    private void L3BtnGo_Action(Event e)
    {
        _l3LblGoErrorMessage.setText(null);
        _l3TfFPLIndexes.setText(null);
        _l3TfFPLItemsProducts.setText(null);
